...
public class ProductService {
    ...
    public void updateProductById(UpdateProductDto updateProductDto) {
        Product product = productRepository.findById(updateProductDto.getId())
            ...
            Category category = categoryService.getCategoryById(updateProductDto.getCategoryId());
    ...
    Product product = new Product();
        ...
        product.setCategory(categoryService.getCategoryById(createProductDto.getCategoryId()));
